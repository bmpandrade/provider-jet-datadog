...
func (mg *TagConfiguration) GetTerraformResourceType() string {
	return "datadog_metric_tag_configuration"
}
...
func (tr *TagConfiguration) GetObservation() (map[string]interface{}, error) {
...
func (tr *TagConfiguration) SetObservation(obs map[string]interface{}) error {
...
func (tr *TagConfiguration) GetParameters() (map[string]interface{}, error) {
...
func (tr *TagConfiguration) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this TagConfiguration using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TagConfiguration) LateInitialize(attrs []byte) (bool, error) {
	params := &TagConfigurationParameters{}
