...
func (mg *Metadata) GetTerraformResourceType() string {
	return "datadog_metric_metadata"
}
...
func (tr *Metadata) GetObservation() (map[string]interface{}, error) {
...
func (tr *Metadata) SetObservation(obs map[string]interface{}) error {
...
func (tr *Metadata) GetParameters() (map[string]interface{}, error) {
...
func (tr *Metadata) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this Metadata using its observed tfState.
