...
func (mg *IndexOrder) GetTerraformResourceType() string {
	return "datadog_logs_index_order"
}
...
func (tr *IndexOrder) GetObservation() (map[string]interface{}, error) {
...
func (tr *IndexOrder) SetObservation(obs map[string]interface{}) error {
...
func (tr *IndexOrder) GetParameters() (map[string]interface{}, error) {
...
func (tr *IndexOrder) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this IndexOrder using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IndexOrder) LateInitialize(attrs []byte) (bool, error) {
	params := &IndexOrderParameters{}
