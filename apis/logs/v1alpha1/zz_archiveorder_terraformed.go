...
func (mg *ArchiveOrder) GetTerraformResourceType() string {
	return "datadog_logs_archive_order"
}
...
func (tr *ArchiveOrder) GetObservation() (map[string]interface{}, error) {
...
func (tr *ArchiveOrder) SetObservation(obs map[string]interface{}) error {
...
func (tr *ArchiveOrder) GetParameters() (map[string]interface{}, error) {
...
func (tr *ArchiveOrder) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this ArchiveOrder using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ArchiveOrder) LateInitialize(attrs []byte) (bool, error) {
	params := &ArchiveOrderParameters{}
