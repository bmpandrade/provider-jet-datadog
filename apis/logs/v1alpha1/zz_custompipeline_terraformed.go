...
func (mg *CustomPipeline) GetTerraformResourceType() string {
	return "datadog_logs_custom_pipeline"
}
...
func (tr *CustomPipeline) GetObservation() (map[string]interface{}, error) {
...
func (tr *CustomPipeline) SetObservation(obs map[string]interface{}) error {
...
func (tr *CustomPipeline) GetParameters() (map[string]interface{}, error) {
...
func (tr *CustomPipeline) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this CustomPipeline using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CustomPipeline) LateInitialize(attrs []byte) (bool, error) {
	params := &CustomPipelineParameters{}
