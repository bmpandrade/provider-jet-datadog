...
func (mg *PipelineOrder) GetTerraformResourceType() string {
	return "datadog_logs_pipeline_order"
}
...
func (tr *PipelineOrder) GetObservation() (map[string]interface{}, error) {
...
func (tr *PipelineOrder) SetObservation(obs map[string]interface{}) error {
...
func (tr *PipelineOrder) GetParameters() (map[string]interface{}, error) {
...
func (tr *PipelineOrder) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this PipelineOrder using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PipelineOrder) LateInitialize(attrs []byte) (bool, error) {
	params := &PipelineOrderParameters{}
