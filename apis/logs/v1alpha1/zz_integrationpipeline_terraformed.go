...
func (mg *IntegrationPipeline) GetTerraformResourceType() string {
	return "datadog_logs_integration_pipeline"
}
...
func (tr *IntegrationPipeline) GetObservation() (map[string]interface{}, error) {
...
func (tr *IntegrationPipeline) SetObservation(obs map[string]interface{}) error {
...
func (tr *IntegrationPipeline) GetParameters() (map[string]interface{}, error) {
...
func (tr *IntegrationPipeline) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this IntegrationPipeline using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IntegrationPipeline) LateInitialize(attrs []byte) (bool, error) {
	params := &IntegrationPipelineParameters{}
