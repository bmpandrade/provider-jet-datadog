...
func (tr *List) GetObservation() (map[string]interface{}, error) {
...
func (tr *List) SetObservation(obs map[string]interface{}) error {
...
func (tr *List) GetParameters() (map[string]interface{}, error) {
...
func (tr *List) SetParameters(params map[string]interface{}) error {
