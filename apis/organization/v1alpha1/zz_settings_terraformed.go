...
func (mg *Settings) GetTerraformResourceType() string {
	return "datadog_organization_settings"
}
...
func (tr *Settings) GetObservation() (map[string]interface{}, error) {
...
func (tr *Settings) SetObservation(obs map[string]interface{}) error {
...
func (tr *Settings) GetParameters() (map[string]interface{}, error) {
...
func (tr *Settings) SetParameters(params map[string]interface{}) error {
