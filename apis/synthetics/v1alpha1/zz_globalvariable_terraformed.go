...
func (mg *GlobalVariable) GetTerraformResourceType() string {
	return "datadog_synthetics_global_variable"
}
...
func (tr *GlobalVariable) GetObservation() (map[string]interface{}, error) {
...
func (tr *GlobalVariable) SetObservation(obs map[string]interface{}) error {
...
func (tr *GlobalVariable) GetParameters() (map[string]interface{}, error) {
...
func (tr *GlobalVariable) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this GlobalVariable using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GlobalVariable) LateInitialize(attrs []byte) (bool, error) {
	params := &GlobalVariableParameters{}
