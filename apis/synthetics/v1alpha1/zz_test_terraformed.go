...
func (tr *Test) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"api_step[*].request_basicauth[*].password": "spec.forProvider.apiStep[*].requestBasicauth[*].passwordSecretRef", "api_step[*].request_client_certificate[*].cert[*].content": "spec.forProvider.apiStep[*].requestClientCertificate[*].cert[*].contentSecretRef", "api_step[*].request_client_certificate[*].key[*].content": "spec.forProvider.apiStep[*].requestClientCertificate[*].key[*].contentSecretRef", "request_basicauth[*].password": "spec.forProvider.requestBasicauth[*].passwordSecretRef", "request_client_certificate[*].cert[*].content": "spec.forProvider.requestClientCertificate[*].cert[*].contentSecretRef", "request_client_certificate[*].key[*].content": "spec.forProvider.requestClientCertificate[*].key[*].contentSecretRef"}
}
