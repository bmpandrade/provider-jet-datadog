...
func (mg *PrivateLocation) GetTerraformResourceType() string {
	return "datadog_synthetics_private_location"
}
...
func (tr *PrivateLocation) GetObservation() (map[string]interface{}, error) {
...
func (tr *PrivateLocation) SetObservation(obs map[string]interface{}) error {
...
func (tr *PrivateLocation) GetParameters() (map[string]interface{}, error) {
...
func (tr *PrivateLocation) SetParameters(params map[string]interface{}) error {
