...
func (mg *Azure) GetTerraformResourceType() string {
	return "datadog_integration_azure"
}
...
func (tr *Azure) GetObservation() (map[string]interface{}, error) {
...
func (tr *Azure) SetObservation(obs map[string]interface{}) error {
...
func (tr *Azure) GetParameters() (map[string]interface{}, error) {
...
func (tr *Azure) SetParameters(params map[string]interface{}) error {
