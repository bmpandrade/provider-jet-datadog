...
func (mg *PagerdutyServiceObject) GetTerraformResourceType() string {
	return "datadog_integration_pagerduty_service_object"
}
...
func (tr *PagerdutyServiceObject) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"service_key": "spec.forProvider.serviceKeySecretRef"}
}

// GetObservation of this PagerdutyServiceObject
func (tr *PagerdutyServiceObject) GetObservation() (map[string]interface{}, error) {
...
func (tr *PagerdutyServiceObject) SetObservation(obs map[string]interface{}) error {
...
func (tr *PagerdutyServiceObject) GetParameters() (map[string]interface{}, error) {
...
func (tr *PagerdutyServiceObject) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this PagerdutyServiceObject using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PagerdutyServiceObject) LateInitialize(attrs []byte) (bool, error) {
	params := &PagerdutyServiceObjectParameters{}
