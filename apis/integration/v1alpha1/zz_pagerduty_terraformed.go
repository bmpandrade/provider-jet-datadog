...
func (mg *Pagerduty) GetTerraformResourceType() string {
	return "datadog_integration_pagerduty"
}
...
func (tr *Pagerduty) GetObservation() (map[string]interface{}, error) {
...
func (tr *Pagerduty) SetObservation(obs map[string]interface{}) error {
...
func (tr *Pagerduty) GetParameters() (map[string]interface{}, error) {
...
func (tr *Pagerduty) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this Pagerduty using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Pagerduty) LateInitialize(attrs []byte) (bool, error) {
	params := &PagerdutyParameters{}
