...
func (mg *AwsLambdaArn) GetTerraformResourceType() string {
	return "datadog_integration_aws_lambda_arn"
}
...
func (tr *AwsLambdaArn) GetObservation() (map[string]interface{}, error) {
...
func (tr *AwsLambdaArn) SetObservation(obs map[string]interface{}) error {
...
func (tr *AwsLambdaArn) GetParameters() (map[string]interface{}, error) {
...
func (tr *AwsLambdaArn) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this AwsLambdaArn using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AwsLambdaArn) LateInitialize(attrs []byte) (bool, error) {
	params := &AwsLambdaArnParameters{}
