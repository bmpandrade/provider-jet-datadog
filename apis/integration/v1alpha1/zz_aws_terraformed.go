...
func (tr *Aws) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"secret_access_key": "spec.forProvider.secretAccessKeySecretRef"}
}

// GetObservation of this Aws
func (tr *Aws) GetObservation() (map[string]interface{}, error) {
...
func (tr *Aws) SetObservation(obs map[string]interface{}) error {
...
func (tr *Aws) GetParameters() (map[string]interface{}, error) {
...
func (tr *Aws) SetParameters(params map[string]interface{}) error {
