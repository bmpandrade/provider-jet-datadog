...
func (mg *SlackChannel) GetTerraformResourceType() string {
	return "datadog_integration_slack_channel"
}
...
func (tr *SlackChannel) GetObservation() (map[string]interface{}, error) {
...
func (tr *SlackChannel) SetObservation(obs map[string]interface{}) error {
...
func (tr *SlackChannel) GetParameters() (map[string]interface{}, error) {
...
func (tr *SlackChannel) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this SlackChannel using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SlackChannel) LateInitialize(attrs []byte) (bool, error) {
	params := &SlackChannelParameters{}
