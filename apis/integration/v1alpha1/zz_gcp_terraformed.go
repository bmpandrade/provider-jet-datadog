...
func (mg *GCP) GetTerraformResourceType() string {
	return "datadog_integration_gcp"
}
...
func (tr *GCP) GetObservation() (map[string]interface{}, error) {
...
func (tr *GCP) SetObservation(obs map[string]interface{}) error {
...
func (tr *GCP) GetParameters() (map[string]interface{}, error) {
...
func (tr *GCP) SetParameters(params map[string]interface{}) error {
