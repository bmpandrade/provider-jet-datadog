...
func (mg *AwsLogCollection) GetTerraformResourceType() string {
	return "datadog_integration_aws_log_collection"
}
...
func (tr *AwsLogCollection) GetObservation() (map[string]interface{}, error) {
...
func (tr *AwsLogCollection) SetObservation(obs map[string]interface{}) error {
...
func (tr *AwsLogCollection) GetParameters() (map[string]interface{}, error) {
...
func (tr *AwsLogCollection) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this AwsLogCollection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AwsLogCollection) LateInitialize(attrs []byte) (bool, error) {
	params := &AwsLogCollectionParameters{}
