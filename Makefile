...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/DataDog/terraform-provider-datadog/releases/download/v3.8.1
...
IMAGES = provider-jet-datadog provider-jet-datadog-controller
